...
//     var curUp = reflectionMat.transformVector(this.mainCamera.up.clone());
    ...
    curViewMat.mul2(this.mirrorCamera.camera.viewMatrix, reflectionMat);
    ...
    var clipplane = this.CameraSpacePlane(this.mirrorCamera.camera, mirrorPos, mirrorForward, 1);
...
Mirror.prototype.CameraSpacePlane = function(cam, pos, normal, sideSign)
{
    var offsetPos = normal.clone();
    offsetPos = offsetPos.mul(new pc.Vec3(0.02, 0.02, 0.02));
    offsetPos.add(pos);
    var m = cam.viewMatrix; //worldToCameraMatrix;
